...
const navConfig: Array<{
  ...
  { href: '/employees',     labelKey: 'nav.employees',   Icon: Users,        requiredPermission: 'users.view_all' },
  { href: '/leaves',        labelKey: 'nav.leaves',      Icon: Palmtree,     requiredPermission: 'leaves.apply' },
  { href: '/attendance', labelKey: 'nav.attendance', Icon: Clock, requiredPermission: 'attendance.clock' },
